...
<body class="photo">
 ...
 <form action="#" method="post">
  ...
  <questionaire id="box">
   ...
   <p> Les défauts présentés dans la liste ci-dessous sont des causes pour un problème lors d’exécution de programme.
      Mais ils sont généralement rares lors de fonctionnement normale d’un mécanisme. Donc veuillez sélectionner et analyser le défaut attentivement </p>
  <boite class="radio2">
   ...
   <input type="radio" name="dep" value="1">
    <label >Adresse IP</label> <br>
     ...
     <label> Verification des E/S</label> <br>

   
    
    
    <input type="radio" name="dep" value="3">
    <label >Cablage </label> <br>
    </boite>   
...
{ 
  ...
  if($x=="2"){
    header("Location: e-s.php");

  }
  if($x=="3"){
    header("Location: cablage.php");
