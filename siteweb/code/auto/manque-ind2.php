...
<body class="photo">
 ...
 <form action="#" method="post">
  ...
  <questionaire id="box">
   ...
   <h3> Dans  cette niveau veuillez controler le message d’erreur </h3>
  <boite class="radio2">
 
   <h2 > Message D'erreur existe </h2> <br>
...
{ 
  ...
  if($x=="1"){
    header("Location:manque-ind2-oui.php");
   }
  if($x=="2"){
    header("Location: manque-ind2-non.php");
