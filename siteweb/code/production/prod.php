...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/donneé.css">
</head>
<body class="photo">
   ...
   <div class="sortie">
    ...
    <contenu class="box">
      <div>
      <ul>
        <li ><a href="../production.html"></i>Calcul Et Prevésionnement</a></li>
        <li ><a class="active-3" href="production-donneé.html">Enregistrement des Donneés </a></li>
        <li><a href="production-historique.html">Historique De production</i></a></li>
      </ul>
      </div>
      <donneé id="donnee">
        <h1>Donneé de Prodcution </h1>
        <h3>Entrez-vous les données de production a sauvegarder ! </h3>
