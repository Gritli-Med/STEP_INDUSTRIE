...
<body class="photo">
    ...
    <h2 class="titre"> Méssage Envoyé </h2>

<div class="action-2">

<div class="case">

<p class="mes"> Votre message a été envoyé. Un technicien de maintenance sera à votre disposition.  </p>
<a class="ret" href="../auto.php"> Retour </a>
</div>
   <div>
