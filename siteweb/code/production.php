   ...
   <div class="sortie">
    ...
    <contenu class="box">
      ...
      <ul>
        ...
        <li><a href="./production/prod-donnee.php">Enregistrement des Donneés  </a></li>
      ...
      <calcul  >
        ...
        <p> L’effectif est un facteur qui influe directement sur 
          la qualité de la production. Le travail est élaboré dans le
        ...
        <a href="production/effectifs.php">Voir Plus</a>
        ...
        <p> Le but de cette partie est le contrôle de taux d'efficacité de la ligne carrousel.  
          ...
          Cela vous permet de réglager  ce facteur pour avoir le rendement optimal à la fin de chaque journée.</p>
          <h2>     Noter bien : COFAT cherche à obtenir un rendement du linge egale à 80%.</h2>
        <a href="production/rendements.php">Voir Plus</a>
        </diver>
      </calcul>
    </contenu>
  </intermidiare>
