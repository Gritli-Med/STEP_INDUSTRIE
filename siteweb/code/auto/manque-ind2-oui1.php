...
<detail class="box2">
 <form action="#" method="post">
  ...
  <questionaire id="box">
   <h1> Auto diagnostic</h1> 
   <h3> Vous avez indiqué que vous avez reçu un message d’erreur avec indice 1
 </h3>
  <boite class="radio2">
 
   <h2 >Type D'indince </h2> <br>
   <h4>Le message d’erreur commence par l’indice1 est conçue pour les opérateurs de carrousel.
    Veuillez lire le message attentivement est suivre les instructions pour résolue le problème.</h4>

<btn  class="btn">
<button  type="submit" name="retour">Problème résolue</button>
