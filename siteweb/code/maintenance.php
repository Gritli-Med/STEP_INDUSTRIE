...
<body class="photo">
    ...
    <box>
      <div class="boite">
        ...
        <li class="active-2"><a href="maintenance.php">Maintenance  <i class="fa fa-arrow-circle-right"></i></a></li>
      </ul>
    </div>
   <div class="sortie">
    ...
    <contenu class="box">
      ...
      <ul>
        ...
        <li><a href="#"> <i class="fa fa-database" ></i>  Historique De Maintenance </a></li>
    ...
    <div-2>
  <h1 class="form-titre"> Enregistrer Vous Donneés </h1>
  </div-2>
  ...
  <formu >
    ...
    <form action="mainte-inc.php" method="post">
    ...
    <input class="in" type="text" name="duree" placeholder="dureé" >
...
<div-2 class="form-buton">
 
  <input type="submit" name="valider" placeholder="">
  </div-2>
 </formulaire>
    </contenu>
  </intermidiare>
