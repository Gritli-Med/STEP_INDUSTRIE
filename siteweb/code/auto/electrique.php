 ...
 <form action="#" method="post">
  ...
  <boite class="radio2">
   ...
   <h2 > Source de Panne </h2> <br>
     ...
     <label> Moteur</label> <br>

    <input type="radio" name="dep" value="2">
    <label >Simens S7 1200</label> <br>
    
    
    <input type="radio" name="dep" value="3">
    <label >Variateur De Vitesse </label> <br>
    </boite>   
...
{ 
  ...
  if($x=="1"){
    header("Location:moteur.php");
   }
  if($x=="2"){
    header("Location: simens.php");

  }
  if($x=="3"){
    header("Location: variateur.php");
