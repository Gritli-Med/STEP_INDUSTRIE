...
<body class="photo">
 ...
 <form action="#" method="post">
  ...
  <questionaire id="box">
   ...
   <h3> Avant de commencer le diagnostic veuillez présenter votre type de maintenance estimé  </h3>
  <boite class="radio2">
 
   <h2 >  type de maintenance </h2> <br>
   
       <input type="radio"  name="dep" value="1" > 
     <label >Maintenance préventive </label> <br>

    <input type="radio" name="dep" value="2">
    <label >Maintenance corrective</label> <bt>
...
{ 
  ...
  if($x=="2"){
    header("Location: corrective.php");
