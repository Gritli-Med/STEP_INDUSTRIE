 ...
 <form action="#" method="post">
  ...
  <boite class="radio2">
   ...
   <h2 > Source de Panne </h2> <br>
     ...
     <label >roulement</label> <br>

    <input type="radio" name="dep" value="2">
    <label >chaine</label> <br>
    
    
    <input type="radio" name="dep" value="3">
    <label >Base Metallique </label> <br>
    </boite>   
<btn  class="btn">
<button  type="submit" name="submit">Retour</button>

<button type="submit" name="detail">Valider</button>
</btn>
...
{ 
  ...
  if($x=="1"){
    header("Location:detail-roulement.php");
   }
  if($x=="2"){
